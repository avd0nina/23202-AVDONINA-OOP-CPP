...
namespace WAVManagement{
    ...
    public:
        ...
        [[nodiscard]] WAVFormatInfo::Sample read_sample(); //Считываем один сэмпл из аудиоданных

        void skip(size_t count);

        void skip(size_t start_sample, size_t end_sample); //пропускаем кол-во сэмплов
